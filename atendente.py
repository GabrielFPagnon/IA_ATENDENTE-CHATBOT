...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Dual-AI GRATUITO:
  • Gemini 1.5 Flash  → vendas, recomendações, consultas de catálogo
  • Groq (Llama 3.3)  → suporte técnico, comparações, análises

Funcionalidades:
  • 5 modos: técnico, resumido, professor, detalhado, suporte_tecnico
  • 3 tipos de prompt: simples, estruturado, especializado
  • Proteções: Prompt Injection, SQL Injection, fora do escopo, DoS
"""
...
_INJECTION_PATTERNS = [
    ...
    r"esquece?\s+(tudo|todas?\s+as?\s+instru)",
...
# Modelos Groq gratuitos disponíveis (troque conforme preferência):
#   llama-3.3-70b-versatile  → melhor qualidade geral        ← padrão
#   llama-3.1-8b-instant     → mais rápido, respostas simples
#   mixtral-8x7b-32768       → bom para análises longas
groq_model = ChatGroq(
...
# Termos que indicam suporte/análise → vai para Groq
_PALAVRAS_GROQ = [
